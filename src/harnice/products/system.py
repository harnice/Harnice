...
#                   KICAD PROCESSING
#===========================================================================
featuretree_utils.run_macro("kicad_pro_to_netlist_build_macro", "system_builder", "https://github.com/kenyonshutt/harnice-library-public")
...
featuretree_utils.run_macro("basic_channel_mapper_build_macro", "system_builder", "https://github.com/kenyonshutt/harnice-library-public")
