...
#                   KICAD PROCESSING
#===========================================================================
feature_tree_utils.run_macro("kicad_sch_to_pdf", "system_artifacts", "https://github.com/harnice/harnice-library-public", artifact_id="blockdiagram-1")
feature_tree_utils.run_macro("kicad_pro_to_bom", "system_builder", "https://github.com/harnice/harnice-library-public", artifact_id="bom-1")
...
#                   CHANNEL MAPPING
#===========================================================================
feature_tree_utils.run_macro("kicad_pro_to_system_connector_list", "system_builder", "https://github.com/harnice/harnice-library-public", artifact_id="system-connector-list-1")
manifest.new()
channel_map.new()
