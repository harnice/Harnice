...
def generate_esch():
    ...
    shutil.copy(fileio.path("wireviz svg"), fileio.dirpath("svg_outputs"))
    os.rename(os.path.join(fileio.dirpath("svg_outputs"),fileio.name("wireviz svg")), fileio.path("esch master svg"))
