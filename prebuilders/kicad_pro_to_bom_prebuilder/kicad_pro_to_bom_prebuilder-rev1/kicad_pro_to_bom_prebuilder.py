...
# kicad headers
BOM_FIELDS = ["Reference", "MFG", "MPN"]
# output headers
BOM_LABELS = ["box_ref_des", "MFG", "MPN"]
...
cmd = [
    "kicad-cli", "sch", "export", "bom", sch_path,
    "--fields", ",".join(BOM_FIELDS),
    "--labels", ",".join(BOM_LABELS),
    "--output", bom_path,
    "--field-delimiter", "\t",
    "--string-delimiter", ""   # ensure no quotes in output
]
