...
from harnice.products import device, disconnect, flagnote, harness, macro, part, system, tblock
...
def main():
    ...
    md.append(docs_functions.file_structure_to_markdown(device)) 
    ...
    path = docs_functions.harnice_dir() / "docs" / "products" / "_device.md"
    path.parent.mkdir(parents=True, exist_ok=True)
    path.write_text("".join(md), encoding="utf-8")
    ...
    md.append(docs_functions.file_structure_to_markdown(disconnect)) 
    ...
    path = docs_functions.harnice_dir() / "docs" / "products" / "_disconnect.md"
    path.parent.mkdir(parents=True, exist_ok=True)
    path.write_text("".join(md), encoding="utf-8")
    ...
    md.append(docs_functions.file_structure_to_markdown(flagnote)) 

    path = docs_functions.harnice_dir() / "docs" / "products" / "_flagnote.md"
    path.parent.mkdir(parents=True, exist_ok=True)
    path.write_text("".join(md), encoding="utf-8")
    ...
    md.append(docs_functions.file_structure_to_markdown(harness)) 

    path = docs_functions.harnice_dir() / "docs" / "products" / "_harness.md"
    path.parent.mkdir(parents=True, exist_ok=True)
    path.write_text("".join(md), encoding="utf-8")
    ...
    md.append(docs_functions.file_structure_to_markdown(macro)) 

    path = docs_functions.harnice_dir() / "docs" / "products" / "_macro.md"
    path.parent.mkdir(parents=True, exist_ok=True)
    path.write_text("".join(md), encoding="utf-8")
    ...
    md.append(docs_functions.file_structure_to_markdown(part)) 

    path = docs_functions.harnice_dir() / "docs" / "products" / "_part.md"
    path.parent.mkdir(parents=True, exist_ok=True)
    path.write_text("".join(md), encoding="utf-8")
    ...
    md.append(docs_functions.file_structure_to_markdown(system)) 
    ...
    path = docs_functions.harnice_dir() / "docs" / "products" / "_system.md"
    path.parent.mkdir(parents=True, exist_ok=True)
    path.write_text("".join(md), encoding="utf-8")
    ...
    md.append(docs_functions.file_structure_to_markdown(tblock)) 

    path = docs_functions.harnice_dir() / "docs" / "products" / "_titleblock.md"
    path.parent.mkdir(parents=True, exist_ok=True)
    path.write_text("".join(md), encoding="utf-8")
