"""
Example usage:
featuretree_utils.run_macro("multi_channel_junction_mapper", "https://github.com/harnice/library-public", lib_subpath="build_macros", multi_ch_junction_name = "shield", multi_ch_junction_type_ids = [5])
